...
contract VaultGuardiansBaseTest is Base_Test {
    ...
    //! Test for H-3 Guardians can infinitely mint VaultGuardianToken's and take over DAO.
    ...
    //! Test for L-1 Incorrect vault name and symbol
    ...
    function testBecomeTokenGuardianTokenTwoName() public hasGuardian {
        ...
        address tokenVault2 = vaultGuardians.  becomeTokenGuardian(allocationData, link);

        linkVaultShares = VaultShares(tokenVault2);
